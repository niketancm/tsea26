...
;; Saturate to negative value yet to implemented.
	;; set	r0,0xa345
	;; set	r1,0x6789
	;; nop
	;; move	acr0.h,r0
	...
	;; nop
	;; nop
	; now acr0 = 0xffa3456789	
	;; move	r0,acr0	 	 ; r0 = 0xa345
	;; move	r1,sat acr0	 ; r1 = 0xa345
	;; move	r2,mul2 acr0 	 ; r2 = 0x468a
	;; move	r3,sat mul2 acr0 ; r3 = 0x8000 (saturation occurs)
	;; move	r4,mul4 acr0     ; r4 = 0x8d15 (no saturation)
	;; move	r5,sat mul4 acr0 ; r5 = 0x8000 (saturation should occur)
	nop	
	;; out	0x11,r0		; Send the result to the IOS0011 file
	;; out	0x11,r1		; so that the result from srsim can be
 	;; out	0x11,r2		; compared to that of the RTL code.
